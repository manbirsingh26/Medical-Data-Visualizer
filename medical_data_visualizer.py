...
# Import data
url = 'https://raw.githubusercontent.com/manbirsingh26/Medical-Data-Visualizer/main/medical_examination.csv'
df = pd.read_csv(url)

# Add 'overweight' column
#df['overweight'] = np.where(df['weight']/(np.square((df['height']/10)))>25, 1, 0)
